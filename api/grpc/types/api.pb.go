...
func (*PeersRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{36} }
...
func (*PeersResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{38} }
...
func init() {
	...
	proto.RegisterType((*PeersRequest)(nil), "types.PeersRequest")
	proto.RegisterType((*Peer)(nil), "types.Peer")
	proto.RegisterType((*PeersResponse)(nil), "types.PeersResponse")
}
...
func (c *aPIClient) ListPeers(ctx context.Context, in *PeersRequest, opts ...grpc.CallOption) (*PeersResponse, error) {
	out := new(PeersResponse)
	err := grpc.Invoke(ctx, "/types.API/ListPeers", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _API_ListPeers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(PeersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(APIServer).ListPeers(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _API_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _API_ListPeers_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
